(() => {
    ...
    const e = 'checkout',
        ...
        i = {
            [e]: {
                idKey: 'eventId',
                seriesParentIdKey: 'seriesParentId',
        ...
        y = (e, t = !0) => {
            let n = null;
            t && (n = window.open(e, '_blank')), n ? n.focus() : (window.location.href = e);
        },
        p = 'small',
        f = { large: (e) => e >= 800, medium: (e) => e >= 480, [p]: (e) => e, na: (e) => !e },
        w = () => {
            let e = 0;
    ...
    const v = (t) => {
            const { widgetType: n = e } = t,
                { idKey: o, seriesParentIdKey: r, idDisplayName: a } = i[n] || {},
                { [o]: d } = t,
                { [r]: s } = t;
            return {
                id: d,
        ...
        C = (e) => {
            const { type: t, id: n, seriesParentId: i } = v(e),
                o = h[t] && h[t][n] ? n : i,
                { [t]: { [o]: r } = {} } = h;
            return r;
        },
        ...
        E = (e) => !!e.userConfig.preventResizing,
        T = (e) => {
            let t;
            const n =
                    window.innerHeight ||
        ...
        A = {
            widgetRenderComplete: (e, t) => {
                e.iframeContainer &&
                    (E(e) || (T(e), (e.computedHeight = `${t.widgetHeight}px`)),
                    t.canonicalEventUrl &&
                        ...
                        ((e, t, i, o) => {
                            const r = e.userConfig.widgetType,
                                a = `${r}-widget-link-${t}`;
                            if (
                                ((e, t) => e.iframeContainer.parentNode.innerHTML.indexOf(t) > -1)(
                                    e,
                                    a
                                )
                            )
                            ...
                            (d.href = `${i}?ref=${n[r]}`),
                                ...
                                (d.style.fontFamily = 'Benton Sans, Helvetica, Arial, sans-serif'),
            ...
            widgetMisconfigured: (e, t) => {
                ...
                n && (a = n.modalTriggerElementId || n.iframeContainerId || 'unknown'),
                    l(`Widget ${o} ${i} with domElementId ${a} misconfigured`, I),
                    s(
            ...
            widgetModalClose: x,
            orderStart: (e) => {
                e.iframeContainer && !E(e) && T(e);
            },
            backToTicketSelection: (e) => {
                e.iframeContainer && !E(e) && (e.iframeContainer.style.height = e.computedHeight);
            },
            orderComplete: (e, t) => {
        ...
        L = (e, t, n) => {
            (t.style.height = t.clientHeight),
                ...
                t.addEventListener('transitionend webkitTransitionEnd oTransitionEnd', P);
            const i = ((e, t) => {
                const { widgetIdentifier: { type: n, id: i } = {}, iframeTitle: o = '' } = e,
        ...
        M = 2147483647,
        O = (e, t, n = 0) =>
            !(n > 20 || e === document.body || !e) && (e.id === t || O(e.parentElement, t, n++)),
        H = (e, t, n) => {
            ...
            document.addEventListener('click', (i) => {
                ...
                (() => {
                    ...
                    (e.innerHTML =
                        ...
                        (t.style.transition = 'opacity 1s ease-in-out, background 1s ease-in-out'),
                        (t.style.zIndex = M),
        ...
        S = {
            [e]: ({
                ...
                let m = `${I}/checkout-external?eid=${e}&parent=${c}`;
                if (
                    (k ||
                        s(
                    ...
                    r && (m = `${m}&promo_code=${encodeURIComponent(r)}`),
                    a && (m = `${m}&w=${a}`),
                    n && (m = `${m}&_eboga=${n}`),
                    d)
                ) {
        ...
        U = (e, t) => {
            for (const n in e)
                if (Object.prototype.hasOwnProperty.call(e, n)) {
                    ...
                    if (t[n] && !R(t[n], i.type)) return s(`'${n}' should be: ${i.type}`), !1;
                }
            return !0;
        };
    let z = 0;
    globalThis.window &&
        ...
        (() => {
            ...
            window.addEventListener && ((t = window.addEventListener), (e = 'message')), t(e, B);
        })(),
